...
public class Action_Employ : GoapAction
{
	public Action_Employ() { }

	public Action_Employ(GoapAgent a) : base(a)
	{
		...
		_effects = new HashSet<Effect> { Effect.EMPLOY_AGENT }; // only makes food
